...
void Player::updatePhysics()
{
	...
	////Collision with window MOVED CODE
	////left collision
	//if (this->getPosition().x - this->pixelSize.x / 2 <= 0.f) {
	//	this->setPosition(this->pixelSize.x/2, this->getPosition().y);
	//}
	////top collision
	//if (this->getPosition().y - this->pixelSize.y <= 0.f){
	//	this->setPosition(this->getPosition().x, this->pixelSize.y+200);
	//}
	////bottom collision
	//if (this->getPosition().y + this->pixelSize.y >= this->screenH-150) {
	//	this->setPosition(this->getPosition().x, this->screenH - this->pixelSize.y-500); //before was -150
	//}
	////right collision
